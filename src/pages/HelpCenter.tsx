...
export default function HelpCenter() {
  ...
  const getCategoryBadgeColor = (category: string) => {
    const colors: Record<string, string> = {
      ...
      "role-specific": "bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300",
      "getting-started": "bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-300",
      ...
      community: "bg-cyan-100 text-cyan-800 dark:bg-cyan-900/30 dark:text-cyan-300",
      account: "bg-teal-100 text-teal-800 dark:bg-teal-900/30 dark:text-teal-300",
    };
