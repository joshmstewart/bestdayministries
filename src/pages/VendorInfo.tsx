                ...
                <CardContent className="pt-6 space-y-4">
                  ...
                  <div className="space-y-3 text-muted-foreground">
                    ...
                    <div className="bg-muted/50 rounded-lg p-4 space-y-2">
                      <p className="font-medium text-foreground">Option 1: Flat Rate Shipping</p>
                      ...
                      <p className="text-sm">Simple and predictable for both you and your customers.</p>
                    </div>

                    <div className="bg-muted/50 rounded-lg p-4 space-y-2">
                      <p className="font-medium text-foreground">Option 2: Dynamic Carrier Rates</p>
                      <p className="text-sm">
                        Real-time shipping rates calculated at checkout based on the customer's ZIP code, your origin ZIP, and the weight/dimensions of the items. Rates are pulled from top carriers including:
                      </p>
                      <ul className="list-disc list-inside space-y-1 text-sm">
                      ...
                      <p className="text-sm">Customers see multiple carrier options at checkout and choose the one that works for them.</p>
                    </div>
                    ...
                    <div className="bg-muted/50 rounded-lg p-4 space-y-2">
                      ...
                      <ul className="list-disc list-inside space-y-1 text-sm">
                        ...
                        <li>For dynamic rates, enter <strong>weight and dimensions</strong> for each product</li>
