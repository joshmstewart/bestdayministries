        ...
        <div className="space-y-4">
          {savedFortunes.map((saved) => {
            ...
            return (
              <Card 
                key={saved.id}
                className="bg-gradient-to-br from-indigo-50/50 to-purple-50/50 dark:from-indigo-900/10 dark:to-purple-900/10 border-indigo-200/30"
              >
                <CardContent className="py-4 space-y-3">
                  {/* Header */}
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2 px-2.5 py-1 rounded-full bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 text-xs">
                  ...
                  {/* Content */}
                  <div className="p-4 rounded-lg bg-white/70 dark:bg-gray-800/50 space-y-2">
