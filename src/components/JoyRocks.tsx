        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="order-1 lg:order-2 space-y-6 animate-fade-in">
            ...
            <div className="space-y-4 text-lg text-muted-foreground leading-relaxed">
              <p>
                Inspired by Bill Stewart's love for the Joy House mission, <strong className="text-foreground font-bold">Joy House Rocks</strong> creates a fun and engaging activity that brings people together to promote positivity and joy.
              </p>
              <p>
