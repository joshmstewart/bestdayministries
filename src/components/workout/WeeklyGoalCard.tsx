        ...
        <div className={cn(
          ...
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2">
              <Target className={cn("h-5 w-5", isGoalMet ? "text-white" : "text-foreground")} />
          ...
          <div className="flex items-end gap-2 mb-3">
            <span className={cn("text-4xl font-bold", isGoalMet ? "text-white" : "text-foreground")}>{completedCount}</span>
          ...
          <Progress 
            value={progress} 
            className={cn("h-3 bg-white/50", isGoalMet ? "[&>div]:bg-white/80" : "[&>div]:bg-primary")} 
          />
