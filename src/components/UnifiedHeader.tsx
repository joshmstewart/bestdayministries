              ...
              <>
                ...
                {isAdmin && (
                  ...
                  >
                    ...
                    {(moderationCount > 0 || pendingVendorsCount > 0 || messageModerationCount > 0 || messagesCount > 0) && (
                      <span className="absolute -top-2 -right-2 h-5 w-5 p-0 flex items-center justify-center rounded-full text-xs bg-destructive text-destructive-foreground">
                        {moderationCount + pendingVendorsCount + messageModerationCount + messagesCount}
                      </span>
                    )}
                  </Button>
                )}
