          ...
          {row.map((key) => {
            ...
            return (
              <button
                ...
                disabled={disabled}
                className={cn(
                  "flex items-center justify-center font-semibold rounded-md transition-all",
                  "hover:opacity-80 active:scale-95 disabled:opacity-50",
                  isSpecial ? "px-2 sm:px-4 h-12 sm:h-14 text-xs sm:text-sm" : "w-8 sm:w-10 h-12 sm:h-14 text-sm sm:text-base",
