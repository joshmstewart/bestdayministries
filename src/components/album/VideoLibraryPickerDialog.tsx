...
import { Video, Youtube, Library, Plus, Play, Check, Search, Loader2 } from "lucide-react";
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-2xl max-h-[85vh] flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription>
            Select a video from your library or paste a YouTube URL.
            To upload a new video, go to Admin → Media → Videos first.
          </DialogDescription>
        </DialogHeader>
              ...
              {loading ? (
                ...
                <div className="flex flex-col items-center justify-center p-8 text-center">
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    Upload videos in Admin → Media → Videos tab
                  </p>
                </div>
              ) : (
