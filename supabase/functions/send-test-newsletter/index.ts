...
serve(async (req) => {
  ...
  try {
    ...
    // Add campaign content (apply email-safe formatting to column layouts and standard tables)
    htmlContent += styleColumnLayoutTables(styleStandardTablesOnly(campaign.html_content));
