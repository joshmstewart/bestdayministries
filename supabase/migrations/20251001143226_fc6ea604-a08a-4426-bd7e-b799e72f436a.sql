...
CREATE POLICY "Public can view settings through view"
ON public.app_settings
FOR SELECT
TO anon, authenticated
USING (false); -- Direct table access blocked
...
-- "Admins and owners can update settings" already exists and is correct