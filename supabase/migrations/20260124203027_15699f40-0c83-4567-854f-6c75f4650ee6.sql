-- Update community_feed_items view to include workout details in extra_data
-- This adds avatar_name, activity_name, location_name, and location_pack_name for workout items
...
-- Workout Generated Images - NOW WITH EXTRA DATA
SELECT wi.id,
