-- Update the moderation notification trigger to NOT fire when content is already approved
...
DECLARE
  ...
  item_title TEXT;
BEGIN
  -- Skip notification if content is already approved (e.g., auto-approved fortune comments)
