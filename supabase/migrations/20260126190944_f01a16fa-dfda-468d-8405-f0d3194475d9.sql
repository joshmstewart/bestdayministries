-- Drop and recreate the community_feed_items view to include price data for announcements
...
UNION ALL
 SELECT content_announcements.id,
    ...
    NULL::bigint AS comments_count,
    jsonb_build_object('announcement_type', content_announcements.announcement_type, 'link_url', content_announcements.link_url, 'link_label', content_announcements.link_label, 'price_coins', content_announcements.price_coins, 'is_free', content_announcements.is_free) AS extra_data,
    NULL::uuid AS repost_id
