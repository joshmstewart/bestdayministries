...
-- Update handle_new_user() to also store first_name and last_name from metadata
...
BEGIN
  ...
  -- Build display_name from first_name + last_name initial, or fall back to display_name metadata
